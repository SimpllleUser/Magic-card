import { Rule, ValidationRule } from './types';
...
export const rules: { [key: string]: Rule } = {
  ...
  [ValidationRule.Required](value: any): boolean | string {
    return !!value || 'Обязательное поле';
  },

  [ValidationRule.RequiredIf](value: any, conditionValue: any): boolean | string {
